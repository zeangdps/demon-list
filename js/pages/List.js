        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <p>
                        Achieved the record using up to 480fps/tps.
                    </p>
                    <p>
                        Achieved the record on the level that is listed on the site - please check the level ID before you submit a record.
                    </p>
                    <p>
                        Have audible clicking in the video. Edited audio only does not count, nor any sort of edits to the completion footage.
                    </p>
                    <p>
                    ...
                    <p>
                        Do not use secret routes, bug routes, or exploits.
                    </p>
                    <p>
